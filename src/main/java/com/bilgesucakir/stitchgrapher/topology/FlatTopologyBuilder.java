...
/**
 * Builds a stitch graph topology for flat patterns where rows alternate direction.
 * Each parsed row is converted into a Row containing StitchNodes with next/child connections
 * to model the crochet structure.
 */
@Component
