...
class CircularPatternServiceTest {

    @Mock
    private PatternParser parser;

    @Mock
    private CircularPatternValidator validator;

    @Mock
    private CircularTopologyBuilder topologyBuilder;

    @InjectMocks
    private CircularPatternService service;
