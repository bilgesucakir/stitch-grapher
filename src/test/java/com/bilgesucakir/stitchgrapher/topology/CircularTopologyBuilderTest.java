...
public class CircularTopologyBuilderTest {
    ...
    void build_twoRowsAllConsuming_buildsCorrectTopology() {
        ...
        assertThat(graph.getRows().get(0).getDirection()).isEqualTo(RowDirection.LEFT_TO_RIGHT);
        assertThat(graph.getRows().get(1).getDirection()).isEqualTo(RowDirection.LEFT_TO_RIGHT);
        ...
        assertThat(nodeFirst.getChildren().get(0).equals(nodeFirstRow1)).isTrue();
        assertThat(nodeSecond.getChildren().get(0).equals(nodeSecondRow1)).isTrue();
        assertThat(nodeThird.getChildren().get(0).equals(nodeThirdRow1)).isTrue();
        ...
        assertThat(nodeFirst.getNext().equals(nodeSecond)).isTrue();
        assertThat(nodeSecond.getNext().equals(nodeThird)).isTrue();
        assertThat(nodeThird.getNext().equals(nodeFirstRow1)).isTrue();
        ...
        assertThat(nodeFirstRow1.getParents().get(0).equals(nodeFirst)).isTrue();
        assertThat(nodeSecondRow1.getParents().get(0).equals(nodeSecond)).isTrue();
        assertThat(nodeThirdRow1.getParents().get(0).equals(nodeThird)).isTrue();
        ...
        assertThat(nodeFirstRow1.getPrevious().equals(nodeThird)).isTrue();
    ...
    void build_multipleRowsWithOneStitchEach_buildsCorrectGraph() {
        ...
        assertThat(nodeRow0.getChildren().get(0).equals(nodeRow1)).isTrue();
